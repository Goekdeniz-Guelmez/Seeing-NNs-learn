...
# model = models.Fourier(32, hidden_size=hidden_size, num_hidden_layers=num_hidden_layers, linmap=linmap).to(device)
model = models.SkipConn(hidden_size=hidden_size, num_hidden_layers=num_hidden_layers)
